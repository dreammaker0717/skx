...
$_TITLE="Accessories Profit Report";
$_FIELDS = [
    ...
    (object)array('sName' => 'aor_total_delivered', 'title' => 'Arrived', 'data' => 'aor_total_delivered', 'type'=> 'string'),  
    (object)array('sName' => 'ast_total_cost', 'title' => 'Total Cost', 'data' => 'ast_total_cost', 'type'=> 'string'),  

    (object)array('sName' => 'ast_fix_rate', 'title' => 'Fix Rate', 'data' => 'ast_fix_rate', 'type'=> 'string'),  
    (object)array('sName' => 'ast_sell_through_rate', 'title' => 'Sell Through Rate', 'data' => 'ast_sell_through_rate', 'type'=> 'string'), 

    (object)array('sName' => 'ast_black', 'title' => ($odg[0]["black"]+$odg[0]["stripped"]), 'data' => 'ast_black', 'type'=> 'string'), 
    (object)array('sName' => 'ast_total_writtenoff_price', 'title' => 'Total<br>Written Off<br>Price', 'data' => 'ast_total_writtenoff_price', 'type'=> 'string'),   
    
    (object)array('sName' => 'ast_total_soldnetprice', 'title' => 'Total Sold<br>Net', 'data' => 'ast_total_soldnetprice', 'type'=> 'string'),   
    (object)array('sName' => 'ast_total_soldvat', 'title' => 'Total Sold<br>Vat', 'data' => 'ast_total_soldvat', 'type'=> 'string'),   
    (object)array('sName' => 'ast_total_soldprice', 'title' => 'Total Sold', 'data' => 'ast_total_soldprice', 'type'=> 'string'),   
    (object)array('sName' => 'ast_total_projected_sold', 'title' => 'Total<br>Projected<br>Sold', 'data' => 'ast_total_projected_sold', 'type'=> 'string'),   
    (object)array('sName' => 'ast_total_profit', 'title' => 'Total<br>Profit', 'data' => 'ast_total_profit', 'type'=> 'string'),   
    (object)array('sName' => 'ast_total_projected_profit', 'title' => 'Total<br>Projected<br>Profit', 'data' => 'ast_total_projected_profit', 'type'=> 'string'),    
];
?>
        ...
        "columns" :[                   
            ...
            if(isset($_FIELDS) && count($_FIELDS)>0) {
                for($i=0;$i<count($_FIELDS);$i++) {                    
                    $ad = $_FIELDS[$i];            
                    if($ad->data=="aor_id")                      
                        echo '{"data" : "'.$ad->data.'", "render":function(dat){ return "<a class=stid href=\'/accprofit/"+dat+"\'>"+dat+"</a>";}}'."\r\n";
                    ...
                    else if($ad->data=="ast_total_cost" || $ad->data=="ast_total_soldnetprice" || $ad->data=="ast_total_soldvat" || $ad->data=="ast_total_soldprice" || $ad->data=="ast_total_projected_sold" || $ad->data=="ast_total_writtenoff_price") {
                        echo '{"data" : "'.$ad->data.'", "render":function(dat,tu,ur){ return nf.format(dat); }}'."\r\n";
    
                    }
                    else if($ad->data=="ast_total_profit" || $ad->data=="ast_total_projected_profit") {
                    ...
                    else if($ad->data=="ast_sell_through_rate"){
