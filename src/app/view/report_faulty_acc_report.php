...
<?php
	...
	$_TITLE="Faulty Accessory Stocks";
    ...
    if($BATCHED==0){
        ...
        $_FIELDS = [
            ...
            (object)array('sName' => 'ast_order', 'title' => 'Order No', 'data' => 'ast_order', 'type'=> 'string'),      
            (object)array('sName' => 'aor_date', 'title' => 'Order Date', 'data' => 'aor_date', 'type'=> 'string'),      
            (object)array('sName' => 'sp_name', 'title' => 'Supplier', 'data' => 'sp_name', 'type'=> 'string'),      
            (object)array('sName' => 'aor_reference', 'title' => 'Order Reference', 'data' => 'aor_reference', 'type'=> 'string'),      
                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                <div class="page-pretitle"> 
                                    <h2 class="btn btn-square <?php echo $status_color;?>" style="width:100%;">Faulty Accessory Report</h2>
                                </div>
                            </div>                           
                        </div>
...
$(function() {
    ...
    window.ETable = $('#dataList').dataTable({
        ...
        "ajax":{
            ...
            type:"POST",
            data: function (d) { d.BATCHED=<?php echo $BATCHED;?>;  d.category=$('#category').val(); d.action='faulty_acc_report';},
            dataType:"json"
        },
...
function change_sku(sn, apr_id) {
    ...
    $.ajax({ 
        url:"/accstocksajax/faulty_report",
        data:pd,
        type:'POST', 
        success:function(a) {
