...
$odg = $db->query("select SUM(orange) as orange,SUM(darkgreen) as darkgreen,SUM(gray+sold) as sold,SUM(black+stripped) as black, SUM(actionreq+actioncmp+purple+red+lightblue+brown+lightgreen) as combined from order_distribution WHERE or_type='Standard'")->fetchAll();
