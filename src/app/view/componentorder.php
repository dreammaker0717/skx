								...
								<div class="card">
										...
										<?php if (isset($ord)) {
											  ...
											  foreach ($data as $k => $v) {
												  echo "<tr><td>" .
													  ...
													  "</td>";
												  if ($in === false) {
													  echo "<td>".$v["dop_delivered"]."</td>";
													  if ($v["dop_delivered"] < $v["dop_quantity"]) {
													  	echo "<td style='color:red'>".($v["dop_quantity"] - $v["dop_delivered"])."</td>";
													  } else {
													  	echo "<td style='color:green'>".($v["dop_quantity"] - $v["dop_delivered"])."</td>";
													  }
												  }
												  if ($ord["dor_state"] == "??") {
													  echo "<td><button class='btn btn-sm btn-primary' type='button'>Remove</button></td>";
									...
									<tfoot>
										...
										if ($in === false) {
											...
											$totArrived = 0;
											foreach ($data as $v) {
												$totQty += $v["dop_quantity"];
												$totArrived += $v["dop_delivered"];
											}
											$color = "red";
