...
//                         (object)array('sName' => 'sp_del', 'title' => 'Deleted', 'data' => 'sp_del', 'type'=> 'bool'),
                    ...
                    if($part=="aproducts") {
                        ...
                        $_FIELDS = [
                           ...
                           /* (object)array('sName' => 'apm_pns', 'title' => 'P/N', 'data' => 'apm_pns', 'type'=> 'function', 'fn'=> function($ad) {

                                $r="";
                                $r.='{"data" : "'.$ad->data.'", "render":function(d,t,r){   return (d??"").replaceAll(",","<br/>") +" <a href=\'javascript:addNewMap("+r.apr_id+");\'><b>+</b></a>"; }},'."\r\n";
