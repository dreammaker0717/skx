...
<!------------------------------  New Items Admin  -------------------------------------- -->
                ...
                <li class="nav-item dropdown"> 
					...
					<div class="dropdown-menu"> 
						...
						<a class="dropdown-item" href="/admin/newitem_categories" > Categories </a>  
                ...
                <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown" role="button" aria-expanded="false" > <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns accstock">
						...
						<a class="dropdown-item" href="/accstocks/orange" > <span class="btn btn-primary btn-sm btn-orange me-1 ast_status_1"style="width:100%;" data-bs-toggle="tooltip" data-bs-placement="right" title="Orange - Awaiting Diagnosis - 1">0</span>&nbsp;</a>
						  <a class="dropdown-item" href="/accstocks/purple" > <span class="btn btn-primary btn-sm btn-purple me-1 ast_status_2" style="width:100%;" data-bs-toggle="tooltip" data-bs-placement="right" title="Purple - Awaiting Repair - 2">0</span>&nbsp;</a> 
						
						  <a class="dropdown-item" href="/accstocks/red" > <span class="btn btn-primary btn-sm btn-red me-1 ast_status_3" style="width:100%;" data-bs-toggle="tooltip" data-bs-placement="right" title="Red - Faulty Needing Parts - 3">0</span>&nbsp;</a> 
						
						  <a class="dropdown-item" href="/accstocks/lightblue" > <span class="btn btn-primary btn-sm btn-cyan me-1 ast_status_4" style="width:100%;" data-bs-toggle="tooltip" data-bs-placement="right" title="Light Blue - Parts Ordered - 4">0</span>&nbsp;</a> 
						  <a class="dropdown-item" href="/accstocks/lightgreen" > <span class="btn btn-primary btn-sm btn-lime me-1 ast_status_6" style="width:100%;" data-bs-toggle="tooltip" data-bs-placement="right" title="Light Green - Ready To Sell (Grade B) - 6">0</span>&nbsp;</a> 
						  <a class="dropdown-item" href="/accstocks/green" > <span class="btn btn-primary btn-sm btn-green me-1 ast_status_22" style="width:100%;" data-bs-toggle="tooltip" data-bs-placement="right" title="Green - Ready To Sell (Grade A) - 22">0</span>&nbsp;</a> 
						  <a class="dropdown-item" href="/accstocks/darkgreen" > <span class="btn btn-primary btn-sm btn-teal me-1 ast_status_7" style="width:100%;" data-bs-toggle="tooltip" data-bs-placement="right" title="Dark Green - Ready To Sell (New) - 7">0</span>&nbsp;</a> 
						  <a class="dropdown-item" href="/accstocks/sold" > <span class="btn btn-primary btn-sm btn-secondary me-1 ast_status_16" style="width:100%;" data-bs-toggle="tooltip" data-bs-placement="right" title="Sold Items -16">0</span>&nbsp;</a>
						  <a class="dropdown-item" href="/accstocks/black" > <span class="btn btn-primary btn-sm btn-dark me-1 ast_status_8" style="width:100%;" data-bs-toggle="tooltip" data-bs-placement="right" title="Written Off Items - 8">0</span>&nbsp;</a>
...
<!------------------------------  Accesories Admin  -------------------------------------- -->
	...
	<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10.325 4.317c.426 -1.756 2.924 -1.756 3.35 0a1.724 1.724 0 0 0 2.573 1.066c1.543 -.94 3.31 .826 2.37 2.37a1.724 1.724 0 0 0 1.065 2.572c1.756 .426 1.756 2.924 0 3.35a1.724 1.724 0 0 0 -1.066 2.573c.94 1.543 -.826 3.31 -2.37 2.37a1.724 1.724 0 0 0 -2.572 1.065c-.426 1.756 -2.924 1.756 -3.35 0a1.724 1.724 0 0 0 -2.573 -1.066c-1.543 .94 -3.31 -.826 -2.37 -2.37a1.724 1.724 0 0 0 -1.065 -2.572c-1.756 -.426 -1.756 -2.924 0 -3.35a1.724 1.724 0 0 0 1.066 -2.573c-.94 -1.543 .826 -3.31 2.37 -2.37c1 .608 2.296 .07 2.572 -1.065z" /><circle cx="12" cy="12" r="3" /></svg>
                  ...
                  <div class="dropdown-menu"> 
					  ...
					  <a class="dropdown-item" href="/admin/acc_categories" > Categories </a>
...
<!------------------------------- Warehouse Barcode Label  --------------------------------- --> 				
					...
					<li class="nav-item"> 
						<a class="nav-link" href="/tool/warehouse_stocktake" > 
							<span class="nav-link-icon d-md-none d-lg-inline-block">
								<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><rect x="7" y="3" width="14" height="14" rx="2" /><circle cx="14" cy="8" r="2" /><path d="M12 12a2 2 0 1 0 4 0v-4" /><path d="M17 17v2a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2v-10a2 2 0 0 1 2 -2h2" /></svg></span> 
...
<!------------------------------- Users   --------------------------------- --> 				
						<li class="nav-item"> 
							<a class="nav-link" href="/admin/users" > 
								...
								<span class="nav-link-title">&nbsp;Users</span> </a> 
						</li>
					</ul>				
          		</div>
        	</div>				
