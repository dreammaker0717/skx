...
if($action=="search") {
   ...
   /// var_dump($order_field);
    ...
    $query="select ast_id,aproducts.apr_name,ast_order,aproducts.apr_condition,ast_lastcomment,ast_date,ast_status,apr_sku,
            ast_record,aproducts.apr_box_label,aproducts.apr_box_subtitle,aproducts.apr_image,ast_state,ast_servicetag,act_name 
        from acc_stock left join aproducts on aproducts.apr_id=ast_product  left join acc_categories on act_id = aproducts.apr_category
        where  $_SF            
