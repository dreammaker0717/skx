...
if($part == "aproducts") {
    $key="apr_id";
    $_SELECT = [
            "apr_id","apr_name","apr_sku","apr_condition","apr_box_label","apr_box_subtitle","apr_image","apr_del","apr_category" ,"apr_mpn"
...
if($part == "newitemproducts") {
    ...
    $_SELECT = [
            ...
            ,"ct_id","ct_name","npm_pns","npr_mpn", "npr_magqty", "npr_lowstock"
        ];
