...
if($action == "sold") {
    ...
    try {
        ...
        $db->exec("UPDATE stock SET  st_status=16, st_allocated=0,  st_solddate=CURRENT_TIMESTAMP, st_allocatedto='".$_POST["data"]["allocatedto"]."', st_allocatedemail='',st_soldprice=".$_POST["data"]['allocateprice'].", st_lastcomment='Sold to ".$_POST["data"]["allocatedto"]."'  WHERE st_id=".$st_id);        
...
if($action == "unallocate") {
    ...
    try {
        ...
        if($sself["st_allocated"] =="1") {
            ...
            $db->exec("UPDATE stock SET st_allocated=0, st_allocatedto='', st_allocatedemail='', st_lastcomment='Unallocated'  WHERE st_id=".$st_id);
...
if($action=="search") {
   ...
   /// var_dump($order_field);
    ...
    $query="select st_id,st_product,st_order,st_servicetag,st_lastcomment,st_date,st_status,
            ...
            st_specs,st_retail,st_allocated,st_allocatedto,st_allocatedemail,st_onsale,st_soldprice,st_actionreq,st_record,st_solddate,            
