<?php
if(isset($_POST["t"]) && $_POST["t"]=="dell_part") {
	require_once("dpprint-box-labels.php");
	exit();
}
...
foreach ($items as &$value) {
	...
	$pro1 = $db->get($tp, [$p."pr_name",$p."pr_box_label",$p."pr_box_subtitle",$p."pr_condition"], [ $p."pr_id" => $sto1[$p."st_product"] ]);	

	$model = $pro1[$p."pr_name"];
	$box_label = $pro1[$p."pr_box_label"];
	$box_subtitle = $pro1[$p."pr_box_subtitle"];
	$condition = $pro1[$p."pr_condition"];
